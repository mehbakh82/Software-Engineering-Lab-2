...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("In order to send Telegram message enter 3"); // New option
            ...
            } else if (message instanceof TelegramMessage) { // New condition
